...
description: 'Reference: shared framework for managing internal investigations from intake through final memo — privileged investigation log, document processing with needle-finding, source coverage tracking, Q&A against the log, memo drafting, and audience summaries. Loaded by $employment-legal:investigation-open, $employment-legal:investigation-add, $employment-legal:investigation-query, $employment-legal:investigation-memo, and $employment-legal:investigation-summary; not invoked directly.'
author: alexchlou
author_url: https://github.com/alexchlou/codex-for-legal/tree/main/plugins/employment-legal/skills/internal-investigation
license: Apache-2.0
version: 0.1.0
execution_mode: open
