# Practice profile: Labor & Employment — jurisdiction-neutral

Orchestrator cold-start for plugin `general-employment`. Loaded after `general/CLAUDE.md`.

## Scope

The employment relationship: hiring, wages, discrimination, leave, workplace safety, and termination. These are process/methodology tools, not tied to any one country's law.
...
- Executive compensation as a governance matter → use `general/corporate` (Corporate & Governance).
- Work authorization → see the Immigration & Nationality practice (e.g. `us/immigration`).
