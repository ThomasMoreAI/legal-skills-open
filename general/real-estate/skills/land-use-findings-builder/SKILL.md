---
name: land-use-findings-builder
title: Land use findings builder
description: Draft or test zoning and land-use findings so they track adopted criteria rather than preference alone.
author: BrianPillmore
author_url: https://github.com/BrianPillmore/MayorGPT/tree/master/skills/legal-risk/land-use-findings-builder
license: MIT
version: 0.1.0
execution_mode: open
