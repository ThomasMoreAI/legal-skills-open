...
description: 'Conduct regulatory impact analyses.

  TRIGGERS - Use when user needs help with regulatory-impact-analysis related tasks.'
author: Winbda
author_url: https://github.com/Winbda/claude-skills-collection/tree/master/skills/regulatory-impact-analysis
license: MIT
version: 0.1.0
execution_mode: open
