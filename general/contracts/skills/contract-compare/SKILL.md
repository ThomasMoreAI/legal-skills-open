...
title: Contract Compare — Version Comparison and Favorability Analysis
description: 'Compares two contract versions side-by-side to detect added, removed, and
  ...
  two contracts".'
author: flight505
author_url: https://github.com/flight505/skill-forge/tree/main/plugins/business-tools/general-legal-assistant/skills/contract-compare
license: MIT
version: 0.1.0
execution_mode: open
...
practice: contracts
language: en
tags: [legal, comparison, redline, negotiation, diff]
---
