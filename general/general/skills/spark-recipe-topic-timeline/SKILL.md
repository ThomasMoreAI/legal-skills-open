...
title: 'Recipe: Topic Timeline'
description: Build a chronological narrative for a topic by interleaving meeting transcript excerpts and email thread summaries across a time range.
author: readdle
author_url: https://github.com/readdle/spark-cli-skills/tree/main/skills/recipe-topic-timeline
license: MIT
version: 0.1.0
execution_mode: open
