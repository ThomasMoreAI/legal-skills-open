---
name: legal-translation-uk-english-wouter-van-den-berg
title: Legal Document Translation Skill
...
author_url: https://lawve.ai/en/skills/legal-translation-uk-english-wouter-van-den-berg
license: MIT
version: 0.1.0
execution_mode: open
...
- title: Consumer Retail
  path: references/consumer-retail.md
- title: Corporate Ma Jv
  path: references/corporate-ma-jv.md
- title: Employment
  path: references/employment.md
- title: Energy Infrastructure
  path: references/energy-infrastructure.md
- title: Finance Banking
  path: references/finance-banking.md
- title: General Legal
  path: references/general-legal.md
- title: Ip It Technology
  path: references/ip-it-technology.md
- title: Litigation Settlement
  path: references/litigation-settlement.md
- title: Ndas Service Agreements
  path: references/ndas-service-agreements.md
- title: Permitting Environmental
  path: references/permitting-environmental.md
- title: Public Procurement
  path: references/public-procurement.md
- title: Real Estate
  path: references/real-estate.md
- title: Taxes
  path: references/taxes.md
- title: Trading Capital Markets
  path: references/trading-capital-markets.md
- title: Transport And Insurance
  path: references/transport-and-insurance.md
---
