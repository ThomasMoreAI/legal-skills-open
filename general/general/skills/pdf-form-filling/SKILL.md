...
title: PDF Form Filling with Python
description: Fill PDF form fields programmatically using Python libraries like pypdf or pdfrw
author: cxcscmu
author_url: https://github.com/cxcscmu/SkillLearnBench/tree/main/skills/b1-one-shot-claude-haiku-4-5/court-form-filling/pdf-form-filling
license: MIT
version: 0.1.0
execution_mode: open
