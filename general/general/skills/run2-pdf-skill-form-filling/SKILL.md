---
name: run2-pdf-skill-form-filling
title: Filling PDF Forms with the PDF Skill
description: Fill PDF forms using the PDF skill's form-filling scripts and workflow
author: cxcscmu
author_url: https://github.com/cxcscmu/SkillLearnBench/tree/main/skills/b2-self-feedback-claude-haiku-4-5/court-form-filling/run2_pdf-skill-form-filling
license: MIT
version: 0.1.0
execution_mode: open
