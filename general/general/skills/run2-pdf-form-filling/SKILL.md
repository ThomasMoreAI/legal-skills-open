---
name: run2-pdf-form-filling
title: Filling Fillable PDF Forms
description: Complete workflow for filling fillable PDF forms using Claude Code PDF skill scripts with pypdf.
author: cxcscmu
author_url: https://github.com/cxcscmu/SkillLearnBench/tree/main/skills/b2-self-feedback-claude-opus-4-6/court-form-filling/run2_pdf-form-filling
license: MIT
version: 0.1.0
execution_mode: open
