---
name: matter-workspace-zhou210712
title: /matter-workspace
description: 管理事务工作区——创建、列表、切换、关闭或解除活跃事务。 适用于多客户私人执业场景，将一个客户或委托的上下文与另一个 隔离开。也可以在实质技能需要知道它在哪个事务中工作时使用。
author: zhou210712
author_url: https://github.com/zhou210712/claude-for-legal-ZH/tree/main/ai-governance-legal/skills/matter-workspace
license: Apache-2.0
version: 0.1.0
execution_mode: open
