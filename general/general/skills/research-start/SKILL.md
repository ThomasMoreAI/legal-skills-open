...
description: Research roadmap for a legal issue — statutes to check, case law areas to investigate, regulatory frameworks, Westlaw (connector optional; not enabled in v1) search terms. Leads and frameworks, NOT authoritative citations; students verify and develop everything. Use when a student asks where to start researching, wants a research roadmap for an issue, or needs gaps identified in existing research.
author: alexchlou
author_url: https://github.com/alexchlou/codex-for-legal/tree/main/plugins/legal-clinic/skills/research-start
license: Apache-2.0
version: 0.1.0
execution_mode: open
