...
description: Generates a strategic negotiation support document with leverage analysis, BATNA assessment, risk matrix, and issue-by-issue tactical planning. Use when preparing for settlement conferences, mediations, contract negotiations, deal structuring, or dispute resolution strategy sessions.
author: CaseMark
author_url: https://github.com/CaseMark/skills/tree/main/skills/legal/negotiation-support
license: Apache-2.0
version: 0.1.0
execution_mode: open
...
practice: litigation
language: en
tags: [analysis, memo, transactional]
---
