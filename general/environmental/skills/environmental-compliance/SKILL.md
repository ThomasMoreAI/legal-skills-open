...
description: 'Design environmental compliance programs.

  TRIGGERS - Use when user needs help with environmental-compliance related tasks.'
author: Winbda
author_url: https://github.com/Winbda/claude-skills-collection/tree/master/skills/environmental-compliance
license: MIT
version: 0.1.0
execution_mode: open
