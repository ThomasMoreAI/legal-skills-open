---
name: search-prior-art-4
title: 搜索先行技术
description: 搜索与特定发明或专利权利要求相关的先行技术。涵盖专利文献、非专利文献（学术论文、 产品、开源）、防御性公开和标准必要专利。适用于评估发明的新颖性和非显而易见性、 挑战现有专利的有效性、支持自由实施分析、记录防御性公开，以及回应质疑新颖性或 非显而易见性的专利局意见。
author: pjt222
author_url: https://github.com/pjt222/agent-almanac/tree/main/i18n/zh-CN/skills/search-prior-art
license: MIT
version: 0.1.0
execution_mode: open
