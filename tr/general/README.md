...
Jurisdiction: `tr` · Practice: `general` · Skill language: tr

## Skills (1)

| Skill | What it does |
|---|---|
| [`Legal Researcher`](skills/legal-researcher/) | Hukuki araştırma, içtihat tarama, mevzuat takibi, Yargıtay kararları ve hukuki makale yazımı. |
