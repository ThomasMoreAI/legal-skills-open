---
name: contract-and-proposal-writer-dahaliztupe-sketch
title: Contract & Proposal Writer
description: Generates professional business documents including freelance contracts, proposals, SOWs, NDAs, and MSAs for US, EU, UK, and DACH jurisdictions. Use when starting client engagements, protecting IP, or needing GDPR-compliant clauses quickly.
author: dahaliztupe-sketch
author_url: https://github.com/dahaliztupe-sketch/Kalmeron-Two/tree/main/.agents/skills/business-growth-skills/contract-and-proposal-writer
license: Apache-2.0
version: 0.1.0
execution_mode: open
