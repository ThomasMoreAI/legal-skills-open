---
name: contract-and-proposal-writer-idorgham
title: Contract & Proposal Writer
description: Drafts professional business documents including freelance contracts, NDAs, MSAs, SOWs, and project proposals for US, EU, UK, and DACH jurisdictions. Use when starting client engagements, structuring vendor relationships, or ensuring GDPR-compliant data clauses.
author: iDorgham
author_url: https://github.com/iDorgham/Ai-Workspace-Factory-AIWF/tree/master/factory/library/skills/github_imports/contract-and-proposal-writer
license: MIT
version: 0.1.0
execution_mode: open
