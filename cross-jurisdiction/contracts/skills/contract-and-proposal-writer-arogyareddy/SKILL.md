---
name: contract-and-proposal-writer-arogyareddy
title: Contract & Proposal Writer
description: Generates professional business documents including freelance contracts, SOWs, NDAs, MSAs, and project proposals for US, EU, UK, and DACH jurisdictions. Use when starting client engagements, structuring partnerships, or needing GDPR-compliant templates fast.
author: ArogyaReddy
author_url: https://github.com/ArogyaReddy/alirezarezvani-claude-skills/tree/main/business-growth/contract-and-proposal-writer
license: MIT
version: 0.1.0
execution_mode: open
