---
name: raisonnement-juridique-amaury-fouret
title: Raisonnement Juridique - Méthodologie du Magistrat Civil
...
author_url: https://lawve.ai/en/skills/raisonnement-juridique-amaury-fouret
license: MIT
version: 0.1.0
execution_mode: open
jurisdiction: fr
...
language: en
sources:
- title: Exemples Motivations
  path: references/exemples-motivations.md
- title: Hierarchie Decisions
  path: references/hierarchie-decisions.md
- title: Office Du Juge
  path: references/office-du-juge.md
- title: Structure Jugement
  path: references/structure-jugement.md
- title: Syllogisme Juridique
  path: references/syllogisme-juridique.md
---
...
9. **Inclure le lien Légifrance** officiel pour chaque article cité40:["$","div",null,{"className":"relative z-10 mx-auto max-w-[1400px] px-4 pb-16 sm:px-8 lg:px-16","children":[["$","$L44",null,{"skillId":"87750f42-7760-4ded-b6dd-a4a54825a28a","skillTitle":"Legal Reasoning","skillStatus":"active","skillVisibility":"listed","slug":"raisonnement-juridique-amaury-fouret","shareToken":null,"settingsShareToken":null,"fileTree":["references/","LICENSE.txt","references/exemples-motivations.md","references/hierarchie-decisions.md","references/office-du-juge.md","references/structure-jugement.md","references/syllogisme-juridique.md","SKILL.md"],"textContents":{"LICENSE.txt":"$45","references/exemples-motivations.md":"$46","references/hierarchie-decisions.md":"$47","references/office-du-juge.md":"$48","references/structure-jugement.md":"$49","references/syllogisme-juridique.md":"$4a","SKILL.md":"$4b"},"fileSizes":{"LICENSE.txt":1069,"references/exemples-motivations.md":13350,"references/hierarchie-decisions.md":12014,"references/office-du-juge.md":6212,"references/structure-jugement.md":6887,"references/syllogisme-juridique.md":8403,"SKILL.md":13608},"hasShowcase":false,"hasSandbox":true,"canEdit":false,"isAdmin":false,"demoFiles":[],"sandboxConfig":{"steps":[{"type":"files","filesRequired":false}],"prompt":{"en":"Utilise la capacité raisonnement juridique pour traiter le sujet suivant : Quelle est la portée de la suspension des droits de visite et d'hébergement d'un enfant qui résulte d'une mesure de sûreté ? Cette suspension est elle uniquement applicable en cas de décision antérieure du juge aux affaires familiales ou s'applique t elle aussi en l'absence de toute décision du JAF. Question complémentaire à cette recherche: la source des droits de visite et d'hébergement est elle l'autorité parentale elle-même ?","fr":"Utilise la capacité raisonnement juridique pour traiter le sujet suivant : Quelle est la portée de la suspension des droits de visite et d'hébergement d'un enfant qui résulte d'une mesure de sûreté ? Cette suspension est elle uniquement applicable en cas de décision antérieure du juge aux affaires familiales ou s'applique t elle aussi en l'absence de toute décision du JAF. Question complémentaire à cette recherche: la source des droits de visite et d'hébergement est elle l'autorité parentale elle-même ?"}},"initialDependencies":[],"initialMcpServers":[],"initialOauthConnections":[],"initialAccessGrants":[],"showcase":null,"about":{"locale":"en","sections":[{"title":"What this skill does","body":"Models the legal reasoning of a French judge when analyzing civil cases. Use this skill to analyze a dispute and identify legal issues, construct a structured legal argument (syllogism), draft the reasoning for a civil judgment, search for applicable case law and statutes via Judilibre and Légifrance, legally characterize facts and acts, and distinguish between claims, grounds, and arguments. Based on the Methodological Guides for Drafting Civil Judgments (ENM/Court of Cassation, 2023)."},{"title":"How to use","body":"The best way to start is to try it live right here — run it against your own document or question to see exactly how it operates, without any setup. Once you're comfortable, download the skill files and drop them into any AI assistant — Claude (Anthropic), ChatGPT (OpenAI), Gemini (Google), or Mistral. The same skill file works across all of them, so you are never locked into a single provider."}],"requiredSkills":[],"dependentSkills":[],"author":{"name":"Amaury Fouret
