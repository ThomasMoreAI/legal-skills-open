...
- `sop-designer`: Để xây dựng SOP xử lý dữ liệu nội bộ.
</related_skills>

## Resources & References
- [Checklist tuân thủ Nghị định 13 (VN)](references/vn-data-protection-checklist.md): Dành cho doanh nghiệp tại Việt Nam.
- [Mẫu Điều khoản dịch vụ cơ bản](references/basic-tos-template.md): Cấu trúc khung.
- [Kịch bản kiểm thử (Evals)](evals/test-legal-compliance.md): Các bài test phát hiện kẽ hở pháp lý.
