# Practice profile: Tax — Germany

Orchestrator cold-start for plugin `de-tax`. Loaded after `de/CLAUDE.md`, before invoking a specific skill.
...
Within Germany: the tax codes/statutes, implementing regulations, tax-authority guidance, and case law. For the governing instruments, court hierarchy, and working language, see `de/CLAUDE.md`.
