# Practice profile: Regulatory & Compliance — Germany

Orchestrator cold-start for plugin `de-regulatory`. Loaded after `de/CLAUDE.md`, before invoking a specific skill.
...
Within Germany: the governing regulatory statutes, the rules and guidance of the relevant authority, and administrative-law principles. For the governing instruments, court hierarchy, and working language, see `de/CLAUDE.md`.
