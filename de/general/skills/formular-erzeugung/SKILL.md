...
title: '[VERALTET] Formularerstellung → siehe `/entwurf`'
...
author: Klotzkette
author_url: https://github.com/Klotzkette/claude-fuer-deutsches-recht/tree/main/rechtsberatungsstelle/skills/formular-erzeugung
license: Apache-2.0
version: 0.1.0
execution_mode: open
jurisdiction: de
