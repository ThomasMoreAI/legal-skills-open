---
name: draft-british-statutory-instruments
title: Draft British Statutory Instruments
description: Drafts hypothetical British Statutory Instruments, Regulations, or Byelaws using formal UK legal language and standard legislative structure based on user-provided scenarios.
author: gabrielmoreira
author_url: https://github.com/gabrielmoreira/agent-skills-mirror/tree/main/mirrors/repos/ECNU-ICALK@AutoSkill/SkillBank/ConvSkill/english_gpt4_8_GLM4.7/draft-british-statutory-instruments
license: MIT
version: 0.1.0
execution_mode: open
jurisdiction: gb
practice: regulatory
language: en
tags: [statutory-instrument, legal-drafting, uk-law, regulations, legislative-drafting]
---
...
- **Placeholders:** Use brackets for missing specific details (e.g., `[date]`, `[relevant sections]`, `<NUM>`, `[specific level]`).
