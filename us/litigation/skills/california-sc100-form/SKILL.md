---
name: california-sc100-form
title: California Small Claims Court Form SC-100
description: Understand the structure and fields of the California Small Claims Court Form SC-100
author: cxcscmu
author_url: https://github.com/cxcscmu/SkillLearnBench/tree/main/skills/b1-one-shot-claude-haiku-4-5/court-form-filling/california-sc100-form
license: MIT
version: 0.1.0
execution_mode: open
jurisdiction: us
...
- `Plaintiff_Name`, `Plaintiff_Address`, `Plaintiff_Phone`, etc.
- `Defendant_Name`, `Defendant_Address`, etc.
- `Nature_of_Claim`, `Facts_of_Claim`
- `Amount_Claimed`, `Amount_Demanded`
- `DateOfDispute`, `DateOfIncident`
- Various checkboxes for claim types

## Important Notes for Filling

1. **Leave blank**: Case number, date stamped, court use only sections
2. **County**: Usually auto-filled based on court location
3. **Amounts**: Write out numerically (e.g., $1500.00)
4. **Dates**: Format as mm/dd/yyyy or yyyy-mm-dd depending on form
5. **Names**: Use full legal names
6. **Addresses**: Include apartment/unit numbers if applicable
7. **Phone Numbers**: Include area code
8. **Signature**: Leave blank unless instructed otherwise
9. **Checkboxes**: Mark with "Yes" or check mark depending on form

## Section Priority for Filling

Fill in this order:
1. Plaintiff (you) information
2. Defendant information
3. Nature and facts of claim
4. Amount claimed
5. Dates relevant to the dispute
6. Declaration (automatic wording is usually pre-printed)
